...
export function numberMatcher(tape: CharTape, offset: number): Nullable<Token> {
...
export function identMatcher(tape: CharTape, offset: number): Nullable<Token> {
...
export function spacesMatcher(tape: CharTape, offset: number): Nullable<Token> {
  let out = "";
...
export function singleLineCommentMatcher(tape: CharTape, offset: number): Nullable<Token> {
